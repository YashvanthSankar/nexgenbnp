        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold text-white tracking-tight">NEXGEN</span>
            </Link>
            <p className="text-gray-500 mb-6 leading-relaxed text-sm">
              Building excellence since 2001. Your trusted partner in construction and real estate development.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Residential Construction', 'Commercial Buildings', 'Real Estate Development', 'Interior Design'].map((item) => (
                <li key={item}>
                  <Link
                    href="/services"
                    className="text-gray-500 hover:text-white text-sm transition-colors duration-200"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              <li className="flex items-start gap-3">
                ...
                <span>123 Construction Avenue<br />Bangalore - 560001</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>info@nexgenbuilders.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-600 text-sm">
              © {currentYear} NEXGEN Builders & Promoters. All rights reserved.
            </p>
